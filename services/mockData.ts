...
// Scenario: 
// Company Book Balance: $10,000
// Bank Balance: $12,500

export const MOCK_LEDGER: Transaction[] = [
  { id: uid(), date: '2023-10-01', description: 'Saldo Inicial', reference: '', amount: 0, type: 'DEBIT', source: TransactionSource.LEDGER, status: MatchStatus.MATCHED },
  ...
  { id: uid(), date: '2023-10-12', description: 'Cobro Cliente XYZ', reference: 'DEP-1002', amount: 1200.00, type: 'DEBIT', source: TransactionSource.LEDGER, status: MatchStatus.UNMATCHED }, // Error in recording?
...
export const MOCK_BANK: Transaction[] = [
  { id: uid(), date: '2023-10-01', description: 'SALDO ANTERIOR', reference: '', amount: 0, type: 'CREDIT', source: TransactionSource.BANK, status: MatchStatus.MATCHED },
  ...
  { id: uid(), date: '2023-10-12', description: 'DEPOSITO CHEQUE', reference: 'DEP-1002', amount: 1250.00, type: 'CREDIT', source: TransactionSource.BANK, status: MatchStatus.UNMATCHED }, // Amount diff $50
  { id: uid(), date: '2023-10-30', description: 'COMISION MANTENIMIENTO', reference: 'COM-OCT', amount: 50.00, type: 'DEBIT', source: TransactionSource.BANK, status: MatchStatus.UNMATCHED }, // Not in books
  { id: uid(), date: '2023-10-31', description: 'INTERESES GANADOS', reference: 'INT-OCT', amount: 15.00, type: 'CREDIT', source: TransactionSource.BANK, status: MatchStatus.UNMATCHED }, // Not in books
];
